...
def get_random_config(id, prefix):
    return {
        "D_batch_size_pretrain": randint(50, 400),
        "D_epochs_pretrain": randint(20, 50),
        "D_batch_size": randint(50, 300),
        "D_lr": uniform(0.001, 0.005),
        "D_epochs": randint(10, 30),
        "AE_batch_size": randint(50, 450),
        "AE_lr": uniform(0.0001, 0.006),
        "AE_epochs": randint(20, 95),
        "iterations": 20,
        "T_epochs": 100,
        "T_batch_size": 100,
        "T_lr": 0.0001,
